...
import { Text, View, ScrollView, Image, TouchableOpacity, Dimensions,BackHandler, StatusBar } from 'react-native'
                            ...
                            <View style={{
                            ...
                            }}>
                                {
                                    this.state.engineers_Categorie.map((category, index) => (
                                        <TouchableOpacity
                                            onPress={() => {
                                                this.props.navigation.navigate('Search', { person: category, icon: 'engineering',index: index })
                                            }}
                                            style={{
                                                width: width * 0.25,
                                                height: scale(90),
